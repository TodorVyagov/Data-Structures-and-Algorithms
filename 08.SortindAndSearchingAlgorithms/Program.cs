namespace SortingHomework
{
    ...
    internal class Program
    {
        internal static void Main()
        {
            ...
            Console.WriteLine("The complexity of Shuffle is O(n)\nIt iterates through each item in the array(list) only once and puts it into random position.");
            ...
            Console.WriteLine("If you think that Shuffle does not work correctly try to run the program several times.");
